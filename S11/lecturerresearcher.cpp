...
LecturerResearcher::LecturerResearcher(std::string name, std::string institute,
    ...
    : Employee{name, institute, nr}, Lecturer{name, institute, nr, studies,
                                              course},
      Researcher{name, institute, nr, researcharea}, m_researchpercentage{
                                                         researchpercentage} {}
...
std::string LecturerResearcher::classname() const {
  return "LecturerResearcher"; // Lecturer::classname() +
                               // Researcher::classname();
}

void LecturerResearcher::fire() { Lecturer::fire(); }
