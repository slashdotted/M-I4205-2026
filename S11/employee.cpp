...
Employee::~Employee() { cout << "Destroying Employee " << m_name << endl; }

string Employee::name() const { return m_name; }

string Employee::institute() const { return m_institute; }

int Employee::employeenr() const { return m_employeenr; }

string Employee::classname() const { return "Employee"; }
